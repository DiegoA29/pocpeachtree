...
(function () {
    ...
    function transactionsController($scope, $filter, transactionsService, utilsService, SweetAlert, minBalance) {
        ...
        $scope.$watch('amount', function () {
            if (!$scope.amount)
                $scope.amount = 0                
            else if($scope.amount == 0 || ($scope.balance - $scope.amount) < minBalance)
        ...
        $scope.transfer = function(){
            if($scope.amount > 0 && ($scope.balance - $scope.amount) >= minBalance)
                SweetAlert.confirm("Are you sure?", {
                    title: 'Are you sure?',
                    text: `Do you want to transfer $${$scope.amount} to ${$scope.toAccount}?`,
                    type: 'warning',
                    showCancelButton: true,
